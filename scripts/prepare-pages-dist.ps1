...
$requiredFiles = @(
  ...
  "assets/css/operator-mfa.css",
  "assets/css/operator-messages.css",
  "assets/css/operator-test.css",
  ...
  "assets/css/demos/aldara-atelier.css",
  ...
  "assets/js/demos/aldara-atelier.js",
