...
test("embedded dashboard and generic child use the same Dossiers initializer", async () => {
  ...
  const dashboardDossierCacheIdentity = "20260913-pre-project-workspace-r1";
  const registryDossierCacheIdentity = "20260912-project-refresh-retention-r1";
  const windowGuardCacheIdentity = "20260913-pre-project-workspace-r1";
  const windowRegistryCacheIdentity = "20260913-pre-project-workspace-r1";
  const dossierCssCacheIdentity = "20260913-pre-project-workspace-r1";
  const dashboardGuardCacheIdentity = "20260913-pre-project-workspace-r1";
  const dashboardModuleCacheIdentity = "20260913-pre-project-workspace-r1";
  const dashboardCssCacheIdentity = "20260913-pre-project-workspace-r1";
  ...
  assert.ok(registry.includes(`operator-dossiers.mjs?v=${registryDossierCacheIdentity}`));
...
test("Pending retention and trash-first lifecycle commands remain server-bound", async () => {
  ...
  assert.match(html, /operator-dashboard\.css\?v=20260913-pre-project-workspace-r1/);
...
test("Dossiers wires VAT remediation and cache versions without a dashboard duplicate", async () => {
  ...
  assert.match(html, /operator-dashboard\.css\?v=20260913-pre-project-workspace-r1/);
  assert.match(html, /operator-dashboard-guard\.mjs\?v=20260913-pre-project-workspace-r1/);
  assert.match(guard, /operator-dashboard\.js\?v=20260913-pre-project-workspace-r1/);
  assert.match(dashboard, /operator-dossiers\.mjs\?v=20260913-pre-project-workspace-r1/);
