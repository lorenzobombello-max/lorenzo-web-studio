...
function Invoke-LocalGate {
  Invoke-Node --test scripts/dossier-continuity-regression-gate.test.mjs scripts/dossier-continuity-release-integration.test.mjs scripts/operator-dossiers-pricing-refresh.test.mjs scripts/operator-dossiers-pricing-stability-live-preview.test.mjs
