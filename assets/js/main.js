// Cookie consent (homepage only, migrated from shared assets/js/cookie-consent.js).
// The homepage footer already contains a static "Cookievoorkeuren" button (#cookiePreferencesLink),
// so this copy does not need the dynamic footer-insertion logic other pages require.
(function () {
