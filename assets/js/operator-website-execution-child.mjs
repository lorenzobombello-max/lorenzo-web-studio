...
} from "./operator-auto-refresh.mjs?v=20260913-pre-project-workspace-r1";
import {
  createOperatorDossierAuthority,
  dossierReference,
} from "./operator-dossiers.mjs?v=20260913-pre-project-workspace-r1";
import {
...
} from "./operator-project-requirements.mjs?v=20260913-pre-project-workspace-r1";
