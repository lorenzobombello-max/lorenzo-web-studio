...
**Werkelijk ontbrekend:** zeven nieuwe Supabase previewbindings; drie GitHub Actions previewvariables; de previewworkflow op `main`; alle zeven GIT-001C-productiemigraties; de drie previewfunctiedeployments.

**Niet bevestigd met de beschikbare toegang:** de effectieve live scope van een daadwerkelijk door de nog niet gedeployde previewbroker uitgegeven token; Cloudflare Pages-project/configuratie en toegewezen hostname; Wrangler OAuth-autorisatie. Er is dus nog geen onderbouwd CNAME-doel. De gewone browserlogin van de eigenaar wordt niet gedeeld met Wrangler of de geïntegreerde browser; er zijn geen wachtwoorden, cookies of tokens gevraagd.

Preflightbesluit: de eerdere GitHub App-selectieblocker is **opgeheven**: de klantrepository is aanwezig. De bredere Provisioner-installatierechten zijn bewust niet gewijzigd en vormen geen bewijs van de smallere previewtokenscope. Productie-uitvoering blijft **NO-GO** wegens de nog ontbrekende bindings, migraties en deployments en de onbevestigde Cloudflare Pages-status; deze mogen uitsluitend binnen hun afzonderlijk goedgekeurde configuratie-/deploymentstap worden behandeld. Deze NO-GO wijzigt het bestaande hostingakkoord niet.
