create or replace function public.list_operator_pending_sdf_intakes_v1(
...
comment on function public.list_operator_pending_sdf_intakes_v1(uuid) is
  'Authenticated read-only pending SDF projection bound to the caller Auth UUID.';