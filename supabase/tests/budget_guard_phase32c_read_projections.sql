...
insert into public.quote_requests (
  ...
  ('320c0000-0000-4000-8000-000000000002', 'Manual read', 'manual@example.test', 'business', 'EUR 3.200 t/m EUR 6.000', 'flexible', 'Manual v2 read fixture.', true, 'approved', 'budget_guard_v1', '3200_to_6000_inclusive'),
  ('320c0000-0000-4000-8000-000000000003', 'Historical read', 'v1@example.test', 'business', 'EUR 3.000 - EUR 6.000', 'flexible', 'Historical v1 read fixture.', true, 'approved', null, null),
  ('320c0000-0000-4000-8000-000000000004', 'Missing snapshot', 'missing@example.test', 'business', 'EUR 3.200 t/m EUR 6.000', 'flexible', 'Missing snapshot fixture.', true, 'approved', 'budget_guard_v1', '3200_to_6000_inclusive'),
  ('320c0000-0000-4000-8000-000000000005', 'Draft read', 'draft@example.test', 'business', 'EUR 3.200 t/m EUR 6.000', 'flexible', 'Wrong lifecycle fixture.', true, 'approved', 'budget_guard_v1', '3200_to_6000_inclusive'),
  ('320c0000-0000-4000-8000-000000000006', 'Expired read', 'expired@example.test', 'business', 'EUR 3.200 t/m EUR 6.000', 'flexible', 'Expired capability fixture.', true, 'approved', 'budget_guard_v1', '3200_to_6000_inclusive'),
  ('320c0000-0000-4000-8000-000000000007', 'Revoked read', 'revoked@example.test', 'business', 'EUR 3.200 t/m EUR 6.000', 'flexible', 'Revoked capability fixture.', true, 'approved', 'budget_guard_v1', '3200_to_6000_inclusive'),
  ('320c0000-0000-4000-8000-000000000008', 'Malformed read', 'malformed@example.test', 'business', 'EUR 3.200 t/m EUR 6.000', 'flexible', 'Malformed historical fixture.', true, 'approved', 'budget_guard_v1', '3200_to_6000_inclusive');
...
insert into public.quote_request_intakes (
  ...
  ('320c1000-0000-4000-8000-000000000002', '320c0000-0000-4000-8000-000000000002', repeat('2', 64), clock_timestamp() + interval '1 day', null, 'submitted', clock_timestamp() - interval '2 hours', clock_timestamp() - interval '1 hour', true, repeat('b', 64), clock_timestamp() + interval '1 day', null, clock_timestamp() - interval '3 hours'),
  ('320c1000-0000-4000-8000-000000000003', '320c0000-0000-4000-8000-000000000003', repeat('3', 64), clock_timestamp() + interval '1 day', null, 'submitted', clock_timestamp() - interval '2 hours', clock_timestamp() - interval '1 hour', true, repeat('c', 64), clock_timestamp() + interval '1 day', null, clock_timestamp() - interval '3 hours'),
  ('320c1000-0000-4000-8000-000000000004', '320c0000-0000-4000-8000-000000000004', repeat('4', 64), clock_timestamp() + interval '1 day', null, 'submitted', clock_timestamp() - interval '2 hours', clock_timestamp() - interval '1 hour', true, repeat('d', 64), clock_timestamp() + interval '1 day', null, clock_timestamp() - interval '3 hours'),
  ('320c1000-0000-4000-8000-000000000005', '320c0000-0000-4000-8000-000000000005', repeat('5', 64), clock_timestamp() + interval '1 day', null, 'in_progress', clock_timestamp() - interval '1 hour', null, false, null, null, null, clock_timestamp() - interval '2 hours'),
  ('320c1000-0000-4000-8000-000000000006', '320c0000-0000-4000-8000-000000000006', repeat('6', 64), clock_timestamp() - interval '1 minute', null, 'submitted', clock_timestamp() - interval '2 hours', clock_timestamp() - interval '1 hour', true, repeat('e', 64), clock_timestamp() - interval '1 minute', null, clock_timestamp() - interval '3 hours'),
  ('320c1000-0000-4000-8000-000000000007', '320c0000-0000-4000-8000-000000000007', repeat('7', 64), clock_timestamp() + interval '1 day', clock_timestamp() - interval '1 minute', 'submitted', clock_timestamp() - interval '2 hours', clock_timestamp() - interval '1 hour', true, repeat('f', 64), clock_timestamp() + interval '1 day', clock_timestamp() - interval '1 minute', clock_timestamp() - interval '3 hours'),
  ('320c1000-0000-4000-8000-000000000008', '320c0000-0000-4000-8000-000000000008', repeat('8', 64), clock_timestamp() + interval '1 day', null, 'submitted', clock_timestamp() - interval '2 hours', clock_timestamp() - interval '1 hour', true, repeat('0', 64), clock_timestamp() + interval '1 day', null, clock_timestamp() - interval '3 hours');
