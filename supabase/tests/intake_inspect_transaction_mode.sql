...
insert into public.quote_requests (
  ...
  ('f2500000-0000-4000-8000-000000000002', 'Interrupted inspect', 'interrupted-inspect@example.test', 'business', 'Meer dan EUR 6.000', 'flexible', 'Interrupted inspect fixture.', true, 'approved', 'budget_guard_v2', 'above_6000'),
  ('f2500000-0000-4000-8000-000000000003', 'Expired inspect', 'expired-inspect@example.test', 'business', 'Meer dan EUR 6.000', 'flexible', 'Expired inspect fixture.', true, 'approved', 'budget_guard_v2', 'above_6000'),
  ('f2500000-0000-4000-8000-000000000004', 'Cancelled inspect', 'cancelled-inspect@example.test', 'business', 'Meer dan EUR 6.000', 'flexible', 'Cancelled inspect fixture.', true, 'approved', 'budget_guard_v2', 'above_6000'),
  ('f2500000-0000-4000-8000-000000000005', 'Revoked inspect', 'revoked-inspect@example.test', 'business', 'Meer dan EUR 6.000', 'flexible', 'Revoked inspect fixture.', true, 'approved', 'budget_guard_v2', 'above_6000');
...
insert into public.quote_request_intakes (
  ...
  ('f2510000-0000-4000-8000-000000000002', 'f2500000-0000-4000-8000-000000000002', 'in_progress', repeat('b', 64), clock_timestamp() + interval '1 day', null, 'INTERRUPTED', clock_timestamp() - interval '1 hour', clock_timestamp(), 2),
  ('f2510000-0000-4000-8000-000000000003', 'f2500000-0000-4000-8000-000000000003', 'in_progress', repeat('c', 64), clock_timestamp() - interval '1 hour', null, 'ACTIVE', clock_timestamp() - interval '2 hours', clock_timestamp() - interval '2 days', 3),
  ('f2510000-0000-4000-8000-000000000004', 'f2500000-0000-4000-8000-000000000004', 'in_progress', repeat('d', 64), clock_timestamp() + interval '1 day', null, 'CANCELLED', clock_timestamp() - interval '1 hour', clock_timestamp(), 4),
  ('f2510000-0000-4000-8000-000000000005', 'f2500000-0000-4000-8000-000000000005', 'in_progress', repeat('e', 64), clock_timestamp() + interval '1 day', clock_timestamp(), 'CANCELLED', clock_timestamp() - interval '1 hour', clock_timestamp(), 5);
